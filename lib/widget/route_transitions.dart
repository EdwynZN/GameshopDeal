...
import 'package:gameshop_deals/screen/home_riverpod.dart';
...
class Routes{
  static Route<dynamic> getRoute(RouteSettings settings) {
    switch(settings.name){
      case filterRoute:
        return VerticalSlideRoute(builder: (_) => FilterScreen(), settings: settings);
      case homeRoute:
  ...
  return CupertinoPageRoute(
      ...
      builder: (ctx) => AnnotatedRegion<SystemUiOverlayStyle>(
          value: SystemUiOverlayStyle(
            statusBarIconBrightness: Theme.of(ctx).appBarTheme.brightness == Brightness.light ? Brightness.dark : Brightness.light,
            systemNavigationBarIconBrightness: Theme.of(ctx).appBarTheme.brightness == Brightness.light ? Brightness.dark : Brightness.light,
