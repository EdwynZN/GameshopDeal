...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(tag) =>
      "${Intl.plural(tag, zero: 'Notificar cuando sea gratis', other: 'Notificar cuando el precio baje a \$${tag} o menos')}";

  static String m1(change) => "hace ${change}d";

  static String m2(change) => "hace ${change}h";

  static String m3(change) => "hace ${change}min";

  static String m4(change) => "hace ${change}m";

  static String m5(change) => "hace ${change}a";

  static String m6(price, date) => "\$${price} el ${date}";

  static String m7(view) => "${Intl.select(view, {
            'List': 'Lista',
            'Grid': 'Cuadrícula',
            'Detail': 'Detalle',
            'Compact': 'Compacta',
  ...
  static String m8(error, message) => "${Intl.select(error, {
            'CANCEL': 'La petición fue cancelada',
            'CONNECT_TIMEOUT':
                'Tiempo de conexión excedido: Conexión inestable o lenta',
            'RECEIVE_TIMEOUT': 'El servidor esta tardando en responder',
            'SEND_TIMEOUT': 'Conexión inestable o lenta',
            'other': '${message}',
          })}";

  static String m9(money) =>
      "${Intl.plural(money, zero: 'gratis', one: '1 dólar', other: '${money} dolares')}";
  ...
  static String m12(review) => "${Intl.select(review, {
            ...
            'Negative': 'Negativo',
            'Mostly_Negative': 'Mayormente Negativo',
            'Mixed': 'Mixtas',
  ...
  static String m13(sort) => "${Intl.select(sort, {
            'Deal_Rating': 'Valoración de oferta',
            'Title': 'Título',
            'Savings': 'Oferta',
            'Price': 'Precio',
  ...
  static String m14(sort) => "${Intl.select(sort, {
            'Deal_Rating':
                'En una escala del 0 al 10, toma en cuenta precio, descuento, metacritic, historial de oferta, etc',
            'Title': 'Título',
            'Savings': 'Oferta',
            'Price': 'Precio',
            'Metacritic': 'Metacritic',
            ...
            'Release': 'Lanzamiento',
            'Store': 'Tienda',
            'Recent': 'Que tan reciente fue publicado la oferta',
            'other':
                'En una escala del 0 al 10, toma en cuenta precio, descuento, metacritic, historial de oferta, etc',
          })}";

  static String m15(mode) => "${Intl.select(mode, {
  ...
  static String m16(query) => "Buscar \'${query}\'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "all_stores_tooltip":
            MessageLookupByLibrary.simpleMessage("Todas las tiendas"),
        "any_metacritic":
        ...
        "cache_snackbar_cleared":
            MessageLookupByLibrary.simpleMessage("Cache borrado"),
        "cache_subtitle": MessageLookupByLibrary.simpleMessage(
            "Borrar imágenes en cache, búsquedas recientes, etc."),
        ...
        "internal_browser_checkbox":
            MessageLookupByLibrary.simpleMessage("Navegador Interno"),
        "last_tooltip": MessageLookupByLibrary.simpleMessage("Último"),
        "light": MessageLookupByLibrary.simpleMessage("Claro"),
        "no_date": MessageLookupByLibrary.simpleMessage("N/A"),
        "no_game_saved": MessageLookupByLibrary.simpleMessage(
            "No tienes ningun juego guardado"),
        ...
        "recent_searches":
            MessageLookupByLibrary.simpleMessage("Busquedas recientes"),
        ...
        "retail_discount":
            MessageLookupByLibrary.simpleMessage("Descuento en tienda"),
        "retail_discount_tooltip": MessageLookupByLibrary.simpleMessage(
            "Juegos con precio menor a 29 dolares en tiendas"),
        "review": m12,
        ...
        "sort_tooltip": m14,
        "steam_rating":
            MessageLookupByLibrary.simpleMessage("Valoración de Steam"),
        "steamworks": MessageLookupByLibrary.simpleMessage("SteamWorks"),
        "steamworks_tooltip": MessageLookupByLibrary.simpleMessage(
            "Juegos registrados en steam, independientemente de la tienda"),
