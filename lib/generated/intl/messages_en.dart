...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(tag) =>
      "${Intl.plural(tag, zero: 'Alert when price is Free', other: 'Alert when price drops to \$${tag} or below')}";

  static String m1(change) => "${change}d ago";

  static String m2(change) => "${change}h ago";

  static String m3(change) => "${change}m ago";

  static String m4(change) => "${change}mo ago";

  static String m5(change) => "${change}y ago";

  static String m6(price, date) => "\$${price} on ${date}";
  ...
  static String m8(error, message) => "${Intl.select(error, {
            ...
            'SEND_TIMEOUT':
                'Send Timeout, might want to try with a better connection',
            'other': '${message}',
          })}";

  static String m9(money) =>
      "${Intl.plural(money, zero: 'free', one: '1 dollar', other: '${money} dollars')}";

  static String m10(date) => "Releases: ${date}";

  static String m11(date) => "Released on: ${date}";
  ...
  static String m14(sort) => "${Intl.select(sort, {
            'Deal_Rating':
                'On a scale from 0 to 10, it factors in price, percent off, metacritic, release date, price history, etc',
            'Title': 'Title',
            'Savings': 'Savings',
            'Price': 'Price',
            'Metacritic': 'Metacritic',
  ...
  static String m16(query) => "Search for \'${query}\'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "all_stores_tooltip":
            MessageLookupByLibrary.simpleMessage("All Stores"),
        ...
        "change_in_years": m5,
        "cheapest_ever":
            MessageLookupByLibrary.simpleMessage("Cheapest Ever: "),
        ...
        "internal_browser_checkbox":
            MessageLookupByLibrary.simpleMessage("Internal Browser"),
        "last_tooltip": MessageLookupByLibrary.simpleMessage("Last"),
        "light": MessageLookupByLibrary.simpleMessage("Light"),
        "no_date": MessageLookupByLibrary.simpleMessage("N/A"),
        "no_game_saved":
            MessageLookupByLibrary.simpleMessage("There are no games saved"),
        ...
        "retail_discount":
            MessageLookupByLibrary.simpleMessage("Retail discount"),
        ...
        "save_game_tooltip":
            MessageLookupByLibrary.simpleMessage("Open Watchlist"),
        ...
        "suggested_searches":
            MessageLookupByLibrary.simpleMessage("Suggested searches"),
